...
import 'content_overlay.dart';
  ...
  final bool isLocked;
  final String creationDate;
  final List<String> collaboratorNames; // Added this
  final VoidCallback onTap;
  ...
  required this.isLocked,
  required this.creationDate,
  required this.collaboratorNames, // Added this
  required this.onTap,
  });
  ...
  Widget build(BuildContext context) {
    final Color foregroundColor = isLocked ? Colors.white : Colors.black;
    Color secondaryColor = baseColor.withOpacity(0.6);
                ...
                Center(
                  child: SizedBox(
                    ...
                    child: ContentOverlay(
                      title: title,
                      isLocked: isLocked,
                      collaboratorNames: collaboratorNames, // Pass the list down
                    ),
                  ),
                ),
              ],
